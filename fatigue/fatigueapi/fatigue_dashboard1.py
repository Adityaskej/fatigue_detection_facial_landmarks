...
EYE_BLINK_MODEL_PATH = r"C:\Users\User\Downloads\fatigue_detection\fatigue\fatigueapi\models\eye_blink_model.pkl"
YAWN_MODEL_PATH = r"C:\Users\User\Downloads\fatigue_detection\fatigue\fatigueapi\models\yawn_model.pkl"
...
if choice == "Real-time Webcam Detection (Continuous)":
    ...
    if st.session_state.run_webcam:
        ...
        if not cap.isOpened():
            ...
            model = joblib.load(r"C:\Users\User\Downloads\fatigue_detection\fatigue\fatigueapi\models\eye_blink_model.pkl")
...
#     if start_btn:
#         st.session_state.running = True
#         st.success("✅ Drowsy detection started.")
#     if stop_btn:
#         st.session_state.running = False
